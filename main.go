...
func main() {
	...
	// Initialize handlers, assuming you have a function NewHandlers()
	handlers := cyoa.NewHandlers()
  
	// Register the routes with the Echo instance
	cyoa.RegisterHandlers(e, handlers)
